...
export type { PrivateVoting } from "./contracts/PrivateVoting";
export { PrivateVoting__factory } from "./factories/contracts/PrivateVoting__factory";
export type { PrivateVotingSimple } from "./contracts/PrivateVotingSimple";
export { PrivateVotingSimple__factory } from "./factories/contracts/PrivateVotingSimple__factory";
